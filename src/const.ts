...
const DEFAULT_IMAGES = {
  apartment: [
    '/image/huy-nguyen-AB-q9lwCVv8-unsplash.jpg',
    '/image/modern-kitchen-interior-design.jpg',
    '/image/skyscraper-8173578.jpg',
  ],
  house: [
    '/image/s-tsuchiya-f41xZ19S9dY-unsplash.jpg',
    '/image/3d-room-interior-with-classic-design-furniture.jpg',
    '/image/tranquil-space-with-plants.jpg',
  ]
};
